...
export default function Page() {
  ...
  return (
    <main>
    <div className="body flex flex-col w-10/12 lg:w-full lg:flex-row lg:justify-evenly">
      {/* Blog Creation Form */}
      <form className=" flex flex-col lg:w-5/12">
        <div className=' my-2'>
          <label htmlFor="title" className="block font-semibold text-gray-700 w-full">
            Title
          </label>
          <input
          type="text"
        ...
        <div className=' my-2'>
          <label htmlFor="content" className=" block font-semibold text-gray-700">
            Content
          </label>
          <textarea
            id="content"
